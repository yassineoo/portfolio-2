...
export default function Main() {
  ...
  return (
   ...
   <h5 className="px-6 my-3 font-meduim">Computer Science student who is
    really passionate about web development, Proficient with JavaScript and its frameworks both backend and frontend, Possess more than 3 years of hands-on experience building and testing deffrent web applications </h5>
